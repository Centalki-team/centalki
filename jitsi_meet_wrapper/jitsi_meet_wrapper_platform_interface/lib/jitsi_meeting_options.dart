...
class JitsiMeetingOptions {
  ...
  factory JitsiMeetingOptions.fromMap(Map<String, dynamic> map) {
    return JitsiMeetingOptions(
      ...
      isAudioMuted:
          map['isAudioMuted'] != null ? map['isAudioMuted'] as bool : null,
      isAudioOnly:
          map['isAudioOnly'] != null ? map['isAudioOnly'] as bool : null,
      isVideoMuted:
          map['isVideoMuted'] != null ? map['isVideoMuted'] as bool : null,
      userDisplayName: map['userDisplayName'] != null
          ? map['userDisplayName'] as String
          : null,
      ...
      configOverrides: map['configOverrides'] != null
          ? Map<String, Object?>.from(
              map['configOverrides'] as Map<String, Object?>)
          : null,
    );
  }
  ...
  factory JitsiMeetingOptions.fromJson(String source) =>
      JitsiMeetingOptions.fromMap(json.decode(source) as Map<String, dynamic>);
}
